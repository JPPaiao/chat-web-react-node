...
const Chats: React.FC<Props> = ({ channel, listMessage, user }) => {
  ...
  return (
    <div className="text-zinc-400 w-full bg-[#323338] h-screen overflow-hidden">
      ...
      <section className="flex flex-col justify-between h-full pb-12">
        <div className="py-3 flex flex-col-reverse gap-5 h-full scrolls overflow-y-auto">
          {
        ...
        <form onSubmit={handleNewMessage} className="bg-[#323338] sticky bottom-0 w-full">
